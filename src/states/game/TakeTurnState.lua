            ...
            Timer.after(1.5, function()
                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        ...
                        Timer.tween(0.5, {
                            [self.battleState.playerExpBar] = {value = self.playerPokemon.currentExp - 5}
                        })

                        local pokeHP, pokeAtt, pokeDef, pokeSpeed = self.playerPokemon.HP, self.playerPokemon.attack,
                                                                    self.playerPokemon.defense, self.playerPokemon.speed
                        local HPUp, AttackUp, DefenseUp, SpeedUp = self.playerPokemon:levelUp()
                        local statIncreases = {
                            {
                                text = 'HP - ' .. pokeHP .. '+' .. HPUp .. '=' .. pokeHP + HPUp
                            },
                            {
                                text = 'Attack - ' .. pokeAtt .. '+' .. AttackUp .. '=' ..  
                                pokeAtt + AttackUp
                            },
                            {
                                text = 'Defense - ' .. pokeDef .. '+' .. DefenseUp .. '=' .. 
                                pokeDef + DefenseUp
                            },
                            {
                                text = 'Speed - ' .. pokeSpeed .. '+' .. SpeedUp .. '=' ..
                                pokeSpeed + SpeedUp
                            }
                        }
